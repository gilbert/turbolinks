...
var RenderingTests = (function (_super) {
    ...
    RenderingTests.prototype["test preserves permanent elements while updating content"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            var permanentElement2, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t;
            return __generator(this, function (_u) {
                switch (_u.label) {
                    case 0: return [4, this.permanentElement2];
                    case 1:
                        permanentElement2 = _u.sent();
                        _b = (_a = this.assert).equal;
                        return [4, permanentElement2.getVisibleText()];
                    case 2:
                        _b.apply(_a, [_u.sent(), "One"]);
                        _d = (_c = this.assert).equal;
                        return [4, permanentElement2.getAttribute('data-foo')];
                    case 3:
                        _d.apply(_c, [_u.sent(), "one"]);
                        this.clickSelector("#permanent-element-link");
                        return [4, this.nextEventNamed("turbolinks:render")];
                    case 4:
                        _u.sent();
                        _e = this.assert;
                        _g = (_f = permanentElement2).equals;
                        return [4, this.permanentElement2];
                    case 5: return [4, _g.apply(_f, [_u.sent()])];
                    case 6:
                        _e.apply(this, [_u.sent()]);
                        _j = (_h = this.assert).equal;
                        return [4, permanentElement2.getVisibleText()];
                    case 7:
                        _j.apply(_h, [_u.sent(), "Two"]);
                        _l = (_k = this.assert).equal;
                        return [4, permanentElement2.getAttribute('data-foo')];
                    case 8:
                        _l.apply(_k, [_u.sent(), "one"]);
                        this.goBack();
                        return [4, this.nextEventNamed("turbolinks:render")];
                    case 9:
                        _u.sent();
                        _m = this.assert;
                        _p = (_o = permanentElement2).equals;
                        return [4, this.permanentElement2];
                    case 10: return [4, _p.apply(_o, [_u.sent()])];
                    case 11:
                        _m.apply(this, [_u.sent()]);
                        _r = (_q = this.assert).equal;
                        return [4, permanentElement2.getVisibleText()];
                    case 12:
                        _r.apply(_q, [_u.sent(), "One"]);
                        _t = (_s = this.assert).equal;
                        return [4, permanentElement2.getAttribute('data-foo')];
                    case 13:
                        _t.apply(_s, [_u.sent(), "one"]);
                        return [2];
                }
            });
        });
    ...
    Object.defineProperty(RenderingTests.prototype, "permanentElement2", {
        get: function () {
            return this.querySelector("#permanent-2");
        },
        enumerable: true,
        configurable: true
    });
